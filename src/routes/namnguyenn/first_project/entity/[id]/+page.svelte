                    ...
                    <tr class="">
                        ...
                        <td class="border-b border-solid border-grey-lighten-15 align-top">
                            <div class="text-main-lighten-20 px-3 py-2">
                                {#if attribute.name}
                                <div class="ml-3">{attribute.name}</div>
                                {/if}
                            </div>
                        </td>
                        <td class="border-b border-solid border-grey-lighten-15 align-top">
                            <div class="text-main-lighten-20 px-3 py-2">
                                {#if attribute.value}
                                <div class="truncate">{attribute.value.type}</div>
                                {:else}
                                <div class="truncate">undefined</div>
                                {/if}
                            </div>
                        </td>
                        <td class="border-b border-solid border-grey-lighten-15 align-top">
                            <div class="column-setting flex flex-wrap content-between px-3 pt-1.5">
                                ...
                                {/if} -->
                                        {#if attribute.value[attribute.value.type]}
                                        {#if attribute.value[attribute.value.type].limits}
                                <span class="mr-2 mb-1.5 truncate">
                                    <div
                                        class="py-0.5 px-1.5 bg-grey-lighten-15 rounded font-semibold text-main-lighten-20 text-xs truncate">
                                        
                                        {JSON.stringify(attribute.value[attribute.value.type].limits)}
                                    </div>
                                </span>
                                {/if}
                                {/if}
